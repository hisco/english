...
- **Listen Lock**: tap blank boxes to hear numbers, then type the heard code.
- **Directions**: hear a direction from a blank rectangle and choose the matching arrow.
- **Math Reveal**: reveal a simple math problem one box at a time and hear each part.
